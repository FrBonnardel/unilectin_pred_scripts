...
out_aligned_domains_file_name="propeller_aligned_domains.txt";
out_domains_file_name="propeller_domain.txt";
...
for domain_name in domain_name_list:
    ...
    score_similarity["1rd_" + domain_name] = numpy.quantile(values,0.10)
    score_similarity["3rd_" + domain_name] = numpy.quantile(values,0.90)
    score_similarity[domain_name] = list()
